...
declare global {
  ...
  const AMonthPicker: typeof import('antd')['MonthPicker']
  ...
  const FilpText: typeof import('../components/custom/FilpText')['default']
  const FullScreen: typeof import('../components/common/FullScreen')['default']
  const IconAntDesignDeleteOutlined: typeof import('~icons/ant-design/delete-outlined.tsx')['default']
  const IconAntDesignDownloadOutlined: typeof import('~icons/ant-design/download-outlined.tsx')['default']
  ...
  const IconAntDesignPlusOutlined: typeof import('~icons/ant-design/plus-outlined.tsx')['default']
  const IconAntDesignRedo: typeof import('~icons/ant-design/redo.tsx')['default']
  const IconAntDesignRedoOutlineD: typeof import('~icons/ant-design/redo-outline-d.tsx')['default']
  const IconAntDesignRedoOutlined: typeof import('~icons/ant-design/redo-outlined.tsx')['default']
  const IconAntDesignRefreshOutlined: typeof import('~icons/ant-design/refresh-outlined.tsx')['default']
  const IconAntDesignReloadOutlined: typeof import('~icons/ant-design/reload-outlined.tsx')['default']
  const IconAntDesignSearchOutlineD: typeof import('~icons/ant-design/search-outline-d.tsx')['default']
  const IconAntDesignSearchOutlined: typeof import('~icons/ant-design/search-outlined.tsx')['default']
  ...
  const useEngine: typeof import('../hooks/common/engine')['useEngine']
