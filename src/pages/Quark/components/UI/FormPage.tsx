    ...
    if (items) {
      formItem = (
        <span>
                  ...
                  >
                    ...
                    >
                      <Input
                        ...
                        value={
                          formMapPosition
                            ? formMapPosition[item.name].longitude
                            : null
                        }
                        size={item.size}
                      />
                    ...
                    >
                      <Input
                        ...
                        value={
                          formMapPosition
                            ? formMapPosition[item.name].latitude
                            : null
                        }
                        size={item.size}
                      />
                  ...
                  return (
                    ...
                    >
                      <Select
                        ...
                        style={item.style ? item.style : []}
                      >
                        {!!formSearchOptions[item.name] &&
                          formSearchOptions[item.name].map((option: any) => {
                            return (
                    ...
                    >
                      <Upload
                        ...
                        beforeUpload={(file: any) => {
                          ...
                          const isLtSize =
                            file.size / 1024 / 1024 < item.limitSize;
                          if (!isLtSize) {
                            message.error(
                              '图片大小不可超过' + item.limitSize + 'MB!',
                            );
                            return false;
                          }
                          return true;
                    ...
                    >
                      ...
                      >
                        {formImages[item.name] ? (
                          <img
                            src={formImages[item.name].url}
                            alt={formImages[item.name].name}
                            width={80}
                          />
                        ) : (
                          uploadButton
          ...
          {!content.body.form.disableSubmit &&
          !content.body.form.disableReset ? (
            ...
            >
              {content.body.form.tab ? (
                <div className={styles.container}>
                  <Form
                    {...content.body.form.layout}
                    form={form}
                    onFinish={onFinish}
                    initialValues={content.body.form.initialValues}
                  >
                    <Tabs
                      defaultActiveKey="1"
                      tabBarExtraContent={
