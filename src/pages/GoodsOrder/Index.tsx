    ...
    const expandedRowRender = (record:any, index:any) => {
      return <div style={{'backgroundColor':'#ffffff','padding':'0px 10px'}}>
        ...
        <p style={{'textAlign':'right','margin':0,'height':40}}>
          ...
          <span style={{'float':'right'}}>{record.goods_order_status=='待发货'?<Button href={"#/admin/goodsOrder/quickDelivery?id="+record.id}>一键发货</Button> : null} <Button href={"#/admin/goodsOrder/Info?id="+record.id} type="primary">订单详情</Button></span>
        </p>
      </div>;
    };
